...
export default function SiteFooter() {
  return (
    <footer className="bg-[rgb(0,48,146)] text-white">
      {/* Pre-footer CTA */}
      <div className="container mx-auto px-4">
        <div className="relative -translate-y-6">
          <div className="rounded-2xl bg-gradient-to-r from-[rgb(0,48,146)] to-[rgb(0,135,158)] p-6 sm:p-8 shadow-xl">
            <div className="grid gap-6 md:grid-cols-[1.2fr,1fr] md:items-center">
              <div className="space-y-2">
                <p className="text-sm uppercase tracking-wide text-[rgb(255,242,219)]/80">Level up your job search</p>
                <h3 className="text-2xl sm:text-3xl font-bold">Get pro tips and resume templates in your inbox</h3>
                <p className="text-[rgb(255,242,219)]/80">One email a week. No spam. Unsubscribe anytime.</p>
              </div>
              <form className="flex flex-col sm:flex-row gap-3" noValidate>
                ...
                <Input
                  ...
                  className="bg-white text-[rgb(0,48,146)] placeholder:text-[rgb(0,48,146)]/60"
                  aria-label="Email address"
                />
                <Button type="submit" className="bg-[rgb(255,171,91)] text-[rgb(0,48,146)] hover:bg-[rgb(255,242,219)]">
                  Subscribe
      ...
      <div className="container mx-auto px-4 pt-0 pb-10">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-9 w-9 rounded-lg bg-gradient-to-r from-[rgb(0,135,158)] to-[rgb(255,171,91)] flex items-center justify-center">
                <FileText className="h-5 w-5 text-white" aria-hidden="true" />
              </div>
              <span className="text-xl font-bold">ResumeBuilder</span>
            </div>
            <p className="text-[rgb(255,242,219)]/80">
          ...
          <nav aria-labelledby="footer-product" className="space-y-3">
            ...
            <ul className="space-y-2 text-[rgb(255,242,219)]/90">
              <li>
              ...
              <li className="flex items-center gap-2">
                ...
                <Badge className="bg-[rgb(255,171,91)] text-[rgb(0,48,146)] hover:bg-[rgb(255,171,91)]">Soon</Badge>
              </li>
              <li>
                <a className="hover:underline underline-offset-4" href="#">
                  ATS Check
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-[rgb(255,242,219)]/80">
            © {new Date().getFullYear()} ResumeBuilder. All rights reserved.
          </p>

          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="flex items-center gap-4 text-sm text-[rgb(255,242,219)]/90">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                id="language"
                className="bg-white/10 border border-white/20 text-white text-sm rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[rgb(255,171,91)]"
                defaultValue="en"
