      ...
      <div className="container mx-auto px-4 py-3">
        <nav aria-label="Primary" className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              <>
                <Link href="/dashboard" className="text-sm font-medium text-[rgb(0,135,158)] hover:text-[rgb(0,48,146)]">
                  Dashboard
                </Link>
                <DropdownMenu>
...
function MobileMenu({ user, logout }: { user: any; logout: () => Promise<void> }) {
            ...
            <>
              <div className="flex flex-col gap-3">
                <Link
                  href="/dashboard"
                  onClick={() => setOpen(false)}
                  className="text-center rounded-md bg-[rgb(0,48,146)] text-white px-3 py-2 text-sm font-medium hover:bg-[rgb(0,135,158)]"
                >
                  Dashboard
                </Link>
                ...
                <button
                  ...
                  className="text-center rounded-md border border-red-300 text-red-600 px-3 py-2 text-sm font-medium hover:bg-red-50"
                >
                  Log out
                </button>
              </div>
